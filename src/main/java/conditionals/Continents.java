...
public class Continents {
    ...
    public static void main(String[] args) {
        ...
        Continents continents1 = new Continents(1);
        System.out.println(continents1);

        Continents continents2 = new Continents(4);
        System.out.println(continents2);

        Continents continents3 = new Continents(10);
        System.out.println(continents3);
