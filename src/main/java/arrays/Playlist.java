...
public class Playlist {
    ...
    public static void main(String[] args) {
        ...
        int a2 = desertIslandPlaylist.indexOf("Song 5");
        int b2 = desertIslandPlaylist.indexOf("Song 8");
        String tempA = desertIslandPlaylist.get(a2);
        desertIslandPlaylist.set(a2, desertIslandPlaylist.get(b2));
        desertIslandPlaylist.set(b2, tempA);
        System.out.println(desertIslandPlaylist);
